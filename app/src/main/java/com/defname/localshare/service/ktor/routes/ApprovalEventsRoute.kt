...
fun Route.getApprovalEvents(
    ...
    get("/{token}/approval-events/{sessionId}") {
        ...
        call.respondOutputStream {
            ...
            // If already decided, send the state immediately and let the connection close
            ...
            try {
                coroutineScope {
                    ...
                    // Watch for this session to be resolved
                    launch {
                ...
                // coroutineScope cancel or client disconnect — both are normal
            }
        }
    }
}
